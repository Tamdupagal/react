...
function Header() {
    const { setToggle, setToggleForm, dispatch, state : {auth : {role}}} = useContext(AppContext);
        ...
        <header className="header">
            ...
            <div className="header__navigation">
                <ul>
                    ...
                    {role === 'TEACHER' && <li onClick={() => history.push('/teacher/course')}><img src={course} alt="course" /> <span>Course</span></li>}
