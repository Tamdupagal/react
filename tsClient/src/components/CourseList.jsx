...
function CourseList() {
    ...
    const { dispatch, state: {course }, courseModal, setCourseModal, courseId, setCourseId} = useContext(AppContext)
    ...
    return (
                    ...
                    >
                     <Box>
                <TableHeader headerText="Choose a course :" Icon={FaCalendarCheck} >
                    <Button onClick={()=>setCourseModal(false)} Icon={FaTimes} style={{backgroundColor: "#db504a"}}/>
                </TableHeader>
                {course.isLoading ?
